...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <button type="button" class="btn waves-effect waves-light btn-primary" data-bs-toggle="modal" data-bs-target="#login-modal"> <i class="mdi mdi-plus-box-outline"></i>
                Add Phonebook
            </button>
            <!-- ---------------------
            ...
            <form action="{{ url('phonebook') }}" class="ps-3 pe-3" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="name" name="name" required="" placeholder="Input Your Category Phonebook ... ">
                    </div>
